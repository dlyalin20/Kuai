# Generated by Django 3.0.8 on 2021-05-11 02:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='biz', to='Landing.Business')),
            ],
        ),
        migrations.CreateModel(
            name='capacityData',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='Landing.Business')),
            ],
        ),
        migrations.CreateModel(
            name='waitData',
            fields=[
                ...
                ('business', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Landing.Business')),
            ],
        ),
        migrations.CreateModel(
            name='Temp_Business',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscription', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Landing.Subscriber')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
