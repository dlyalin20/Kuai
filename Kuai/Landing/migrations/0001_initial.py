# Generated by Django 3.0.8 on 2021-05-29 20:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('waitTimes', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='review', to='Landing.waitTimes')),
            ],
        ),
        migrations.CreateModel(
            name='Temp_Business',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('affiliatedBusiness', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Landing.Business')),
            ],
        ),
        migrations.AddField(
            model_name='profile',
            name='alltime',
            field=models.ManyToManyField(blank=True, to='Landing.waitData'),
        ),
        migrations.AddField(
            model_name='profile',
